...
CCXXFLAGS:=-std=c++11 -Wall -O3 -g -DNDEBUG -march=native -Wno-deprecated -ffunction-sections -fdata-sections -fopenmp
# C-only flags
CFLAGS+= $(CCXXFLAGS)
# C++-only flags
CXXFLAGS+= $(CCXXFLAGS)
...
OBJS_main = \
	...
	MEMsGraph.o \
	main.o
LIBS_main= $(LIBS) -lrt -lsdsl -ldivsufsort -ldivsufsort64 -lemon -lz
